...
export class ProjectsPage {
  ...
  txt_Control_Arm(...dynamicArgs: string[]): Promise<Locator> {
    return resolveLocator(this.page, this.selectors, 'ProjectsPage', 'txt_Control_Arm', { dynamicArgs });
  }
  ...
  /** textbox from codegen */
  txt_follow_Up_Time_0(...dynamicArgs: string[]): Promise<Locator> {
    return resolveLocator(this.page, this.selectors, 'ProjectsPage', 'txt_follow_Up_Time_0', { dynamicArgs });
  }

  /** button from codegen */
  btn_Follow_up_Time_Year(...dynamicArgs: string[]): Promise<Locator> {
    return resolveLocator(this.page, this.selectors, 'ProjectsPage', 'btn_Follow_up_Time_Year', { dynamicArgs });
  }
