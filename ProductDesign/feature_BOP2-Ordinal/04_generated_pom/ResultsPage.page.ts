...
export class ResultsPage {
  ...
  /** textbox from codegen */
  txt_Pr_CR(...dynamicArgs: string[]): Promise<Locator> {
    return resolveLocator(this.page, this.selectors, 'ResultsPage', 'txt_Pr_CR', { dynamicArgs });
  }

  /** textbox from codegen */
  txt_Pr_PR(...dynamicArgs: string[]): Promise<Locator> {
    return resolveLocator(this.page, this.selectors, 'ResultsPage', 'txt_Pr_PR', { dynamicArgs });
  }
  ...
  /** textbox from codegen */
  txt_other_Scenarios_Table_2_pr1_other(...dynamicArgs: string[]): Promise<Locator> {
    return resolveLocator(this.page, this.selectors, 'ResultsPage', 'txt_other_Scenarios_Table_2_pr1_other', { dynamicArgs });
  }

  /** textbox from codegen */
  txt_other_Scenarios_Table_2_pr2_other(...dynamicArgs: string[]): Promise<Locator> {
    return resolveLocator(this.page, this.selectors, 'ResultsPage', 'txt_other_Scenarios_Table_2_pr2_other', { dynamicArgs });
  }

  /** textbox from codegen */
  txt_other_Scenarios_Table_3_pr1_other(...dynamicArgs: string[]): Promise<Locator> {
    return resolveLocator(this.page, this.selectors, 'ResultsPage', 'txt_other_Scenarios_Table_3_pr1_other', { dynamicArgs });
  }

  /** textbox from codegen */
  txt_other_Scenarios_Table_3_pr2_other(...dynamicArgs: string[]): Promise<Locator> {
    return resolveLocator(this.page, this.selectors, 'ResultsPage', 'txt_other_Scenarios_Table_3_pr2_other', { dynamicArgs });
  }
