...
export class ProjectPage {
  ...
  /** textbox from codegen */
  txt_follow_Up_Time_0_0(...dynamicArgs: string[]): Promise<Locator> {
    return resolveLocator(this.page, this.selectors, 'ProjectPage', 'txt_follow_Up_Time_0_0', { dynamicArgs });
  }
